            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-tittle">Data Dosen</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    <div class="box-header">
                        <a href="tambah_data_dosen.php">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php
                            $no = 1;
                            foreach($db->tampil_data_dosen() as $x){
                                ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                ...
                                <td><a href="edit_data_dosen.php?id=<?php echo$x['nip']; ?>">
                                    <button type="button" class="btn btn-warning" name=""> <i class="fa fa-pencil"></i> Edit</button></a></td>
                                    <td><a onclick="return confirm('Anda yakin?')" href="hapus_data_dosen.php?id=<?php echo $x['nip']; ?>">
